...
async function initShader() {
    ...
    const vertexShaderSource2 = await readShaderFile('shVert2.glsl');
    const fragmentShaderSource2 = await readShaderFile('shFrag2.glsl');
    shader = new Shader(gl, vertexShaderSource, fragmentShaderSource);
    shader2 = new Shader(gl, vertexShaderSource2, fragmentShaderSource2);
}
...
function render() {
    ...
    else { // renderingMode == 'PHONG'
        // drawing the cube
        shader2.use();  // using the cube's shader
